#' @title Caching
#'
#' @description Manage cached `rhdx` files with \pkg{hoardr}
#'
#' @export
#' @name rhdx_cache
#'
#' @details The dafault cache directory is
#' `paste0(rappdirs::user_cache_dir(), "/R/rhdx")`, but you can set
...
#'  \item `rhdx_cache$list()` returns a character vector of full
#'  path file names
