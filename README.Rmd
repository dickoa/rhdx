...
This package is not on yet on CRAN and to install it, you will need the [`devtools`](https://github.com/r-lib/devtools) package and the development version of the [`crul`](https://github.com/ropensci/crul) package.
